...
public class GrocaryArrayList {
    ...
    GrocaryArrayList() {
        ...
        userOrderModelArrayList = new ArrayList<>();
        choice();
    }
...
//        orderProductModelArrayList.add(productModelArrayList.get(productChoice));
        ...
        userOrderModelArrayList.add(new UserOrderModel(productQuntity, productModelArrayList.get(productChoice)));
    ...
    private void chooseMoreProduct(String userName, float orderTotal, ArrayList<UserOrderModel> userOrderModelArrayList) {
        String choice;
...
//            userOrderModelArrayList.add(new UserOrderModel(productQuntity));
           /* for (int i = 0; i < orderModelArrayList.size(); i++) {
                ...
                for (int j = 0; j < orderModelArrayList.get(i).getUserOrderModel().size(); j++) {
                    System.out.println("");
                    System.out.println(j + "." + orderModelArrayList.get(i).getUserOrderModel().get(j).getProductModel().getProductName() + " | "
